...
export class PoExcelResponse extends jspb.Message {
  getUrl(): string;
  setUrl(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PoExcelResponse.AsObject;
  static toObject(includeInstance: boolean, msg: PoExcelResponse): PoExcelResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: PoExcelResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PoExcelResponse;
  static deserializeBinaryFromReader(message: PoExcelResponse, reader: jspb.BinaryReader): PoExcelResponse;
}

export namespace PoExcelResponse {
  export type AsObject = {
    url: string,
  }
}
